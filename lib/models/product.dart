...
class Product extends ChangeNotifier {
  ...
  Future<void> save() async {
    ...
    images = updateImages;
      ...
      updateImages.add('https://firebasestorage.googleapis.com/v0/b/atletica-escorpiao-rei.appspot.com/o/logo.png?alt=media&token=f0daea0e-c3f8-4e25-84f9-5f1a5c2fd034');
      await firestoreRef.updateData({'images': updateImages});
      images = updateImages;
    }
    loading = false;
